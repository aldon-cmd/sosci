...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('catalogue', '0020_auto_20191221_1832'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='product',
            name='picture',
            field=models.CharField(blank=True, help_text='a url pointing directly to a preview image of the first video in a course', max_length=250, null=True),
        ),
        migrations.AlterField(
