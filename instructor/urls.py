...
urlpatterns = [
       re_path(r'^student/invite/modal/$', customer_views.IndividualStudentInviteModalView.as_view(), name='individual-student-invite-modal'),
        ...
        re_path(r'^student/list/$', customer_views.StudentListView.as_view(), name='student-list'),
        re_path(r'^upload/attempt/(?P<course_id>\d+)/$', video_views.VimeoVideoUploadAttemptView.as_view(), name='video-upload-attempt'),	    
